...
public class TestPerformanceIT {
	...
	public void highVolumeTrackLocation() {
		...
		rewardCentral = new RewardCentralProxy(gpsUtil, rewardCentral);
		// Users should be incremented up to 100,000, and test finishes within 15 minutes
		InternalTestDataSet internalTestDataSet = new InternalTestDataSet();
		InternalTestHelper.setInternalUserNumber(1000);
		TourGuideService tourGuideService = new TourGuideService(internalTestDataSet,gpsUtil, rewardCentral, rewardCentral, tripPricer);
